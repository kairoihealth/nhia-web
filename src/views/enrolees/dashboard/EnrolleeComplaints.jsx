...
// EnrolleeComplaints Component
const EnrolleeComplaints = () => {
  ...
  const handleViewComplaint = (row) => {
    navigate(`/enrollee/complaint/${row.id}`, {
      ...
      >
        ...
        >
          <Box>
            <FormCardHeader
              title="My Complaints"
              subtitle="All complaints you have filed with NHIA"
              subtitleSx={{ mb: 0 }}
            />
          </Box>
          ...
          <Button
            variant="contained"
            onClick={() => navigate("/enrollee/complaint/create")}
            sx={{
...
// const EnrolleeComplaints = WithAuthorization(
//   EnrolleeComplaintsPage,
//   "can_view_all_complaints",
// );

export default EnrolleeComplaints;
