...
import { Box, TextField, Button, Select, MenuItem, FormControl, Typography, LinearProgress } from "@mui/material";
          ...
          <Box sx={{
            ...
            <Box>
              ...
              >
                ...
                <Typography sx={{fontSize: "20px", fontWeight: 500, lineHeight: "27px",                   my: 4
 }}>
                  Complainant Details
                </Typography>
                <form>
                ...
                <Typography
                    ...
                    <FormControl sx={{width: {xs: "100%",md:"40%"}}}>
                      ...
                      >
                        ...
                        <Typography sx={{fontSize: "12px", fontWeight: 400, lineHeight: "18px", color: "#475467", mt: 2}}>
                          <span style={{fontWeight: 600, color: "#6941C6"}}>Click to upload</span> or drag and drop
                          <br />
                      ...
                      {files.length > 0 && (
                        <Box mt={2}>
                           ...
                           >
                             <AiOutlineFile size={24} style={{ marginRight: "10px" }} />
                             <Box sx={{ flexGrow: 1 }}>
                               <Typography variant="body2">{file.name}</Typography>
                               <Typography variant="caption" color="textSecondary">
                                 {Math.round(file.size / 1024)} KB - {file.progress}% uploaded
                               </Typography>
                               <LinearProgress variant="determinate" value={file.progress} sx={{ marginTop: "4px" }} />
                             </Box>
                             <Button
                               size="small"
                               color="error"
