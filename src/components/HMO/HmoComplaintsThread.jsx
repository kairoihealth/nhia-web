...
const HmoComplaintsThreadPage = () => {
  ...
  const handleReply = (to) => {
    navigate(`/hmo/complaint/${complaint?.id}/reply`, {
      state: { thread: id, to },
    });
  };
            ...
            >
              <Box>
                ...
                <Typography
                  role="button"
                  onClick={() => {
                    navigate(`/hmo/complaint/${complaint?.id}`, {
            ...
            {allSortedResponses?.length === 0 ? (
              ...
              <Stack divider={<Divider sx={{ my: 2 }} />} spacing={0}>
                {allSortedResponses.map((response) => {
                  ...
                  const officerTag =
                    response.response_by?.role === "Admin" ||
                    response.response_by?.role === "StateAdmin"
                      ? ` ${response.response_by?.officer_code || "Officer"}`
                      : "";
                        ...
                        >
                          ...
                          {response.response_recipient === "All"
                            ...
                            : response.response_recipient === "Complainant"
                              ...
                              : response.response_recipient === "NHIA"
                                ? "NHIA"
                                : `${
                                    complaint?.hmo?.name ||
                                    complaint?.provider?.name
