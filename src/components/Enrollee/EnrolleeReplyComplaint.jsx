...
const EnrolleeReplyComplaint = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.data?.id) {
        navigate(`/enrollee/complaint/${complaint?.id}/thread`, {
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
          ...
          <Box>
            <TextField
              ...
              variant="outlined"
              sx={multiLineStyles}
              placeholder={`Type your response to ${to || "all parties"} here...`}
              slotProps={{
...
export default EnrolleeReplyComplaint;
